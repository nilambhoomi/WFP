...
public partial class IEReport : System.Web.UI.Page
{
    private static int PageSize = 10;
    private static string fmdt = "01/10/2019";
    private static string todt = "31/10/2019";
    protected void Page_Load(object sender, EventArgs e)
    {
        //if (!IsPostBack)
        //{
        //    //txtFromDate.Text = DateTime.Now.AddDays(-7).ToString("dd/MM/yyyy");
        txtFromDate.Text = "01/10/2019";
        txtToDate.Text = "31/10/2019";
        string frmdt = txtFromDate.Text;
        string toDate = txtToDate.Text;
        BindGrid(frmdt, toDate);
        //ClientScript.RegisterStartupScript(GetType(), "Javascript", "javascript:GetCustomers(1); ", true);
        // }
    }
    [WebMethod]
    public static string GetLatestVisit(int pageIndex)
    {
        string frmDate = DateTime.Parse(fmdt).ToString("yyyy-MM-dd");
        string ToDate = DateTime.Parse(todt).ToString("yyyy-MM-dd");
        string query = "[GetWFP_IEReport]";
    ...
    private void BindGrid(string frmDt, string toDt)
    {
        ...
        cmd.CommandText = "GetWFP_IEReport";
        ...
        try
        {
            ...
            gvLatestVisit.EmptyDataText = "No Records Found";
            DataTable dt = new DataTable();
            dt.Load(cmd.ExecuteReader());
            Session["Datatableprocedure"] = dt;
            gvLatestVisit.DataSource = cmd.ExecuteReader();
            gvLatestVisit.DataBind();
            // con.Close();
    ...
    protected void btnExportToExcel_Click(object sender, EventArgs e)
    {
        ...
        {
            wb.Worksheets.Add(dt, "WFPIEReports");
            Response.Clear();
