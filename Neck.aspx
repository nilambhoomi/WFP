<%@ Page Language="C#" MasterPageFile="~/PageMainMaster.master" AutoEventWireup="true" CodeFile="Neck.aspx.cs" Inherits="Neck" EnableEventValidation="false" %>
            ...
            <div class="col-lg-10" id="content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                        ...
                        <%-- <asp:DropDownList ID="ddlLevels" runat="server" Style="height: 30px; float: left; width: 150px">
                ...
                <div class="row" id="divTP" runat="server">
                    <div class="col-md-3">
