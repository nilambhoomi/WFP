<%@ Page Title="" Language="C#" MasterPageFile="~/common.master" AutoEventWireup="true" CodeFile="RODReports.aspx.cs" Inherits="RODReports" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            $.ajax({
                type: "POST",
                url: "RODReports.aspx/GetRODReport",
