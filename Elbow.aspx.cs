...
public partial class Elbow : System.Web.UI.Page
{
    ...
    public string SaveUI(string ieID, string ieMode, bool bpIsChecked)
    {
        ...
        if (_ieMode == "Update" || _ieMode == "New")
        {
            ...
            //TblRow["ExtraForRangeOfMotionLeft"] = txtExtraForRangeOfMotionLeft.Text.ToString();
            //TblRow["ExtraForTinelLeft"] = txtExtraForTinelLeft.Text.ToString();
            //TblRow["ExtraForRangeOfMotionRight"] = txtExtraForRangeOfMotionRight.Text.ToString();
            //TblRow["ExtraForTinelRight"] = txtExtraForTinelRight.Text.ToString();
    ...
    public void PopulateUI(string ieID)
    {
        ...
        if (sqlTbl.Rows.Count > 0)
        {
            ...
            //txtExtraForRangeOfMotionLeft.Text = Convert.ToString(TblRow["ExtraForRangeOfMotionLeft"]);
            //txtExtraForTinelLeft.Text = Convert.ToString(TblRow["ExtraForTinelLeft"]);
            //txtExtraForRangeOfMotionRight.Text = Convert.ToString(TblRow["ExtraForRangeOfMotionRight"]);
            //txtExtraForTinelRight.Text = Convert.ToString(TblRow["ExtraForTinelRight"]);
    ...
    public void PopulateUIDefaults()
    {
        ...
        foreach (XmlNode node in nodeList)
        {
            ...
            //txtFlex3.Text = node.SelectSingleNode("FlexionROMNormal") == null ? txtFlex3.Text.ToString().Trim() : node.SelectSingleNode("FlexionROMNormal").InnerText;
            //txtExtension3.Text = node.SelectSingleNode("ExtensionROMNormal") == null ? txtExtension3.Text.ToString().Trim() : node.SelectSingleNode("ExtensionROMNormal").InnerText;
            //txtSupination3.Text = node.SelectSingleNode("SupinationROMNormal") == null ? txtFlex3.Text.ToString().Trim() : node.SelectSingleNode("SupinationROMNormal").InnerText;
            //txtPronation3.Text = node.SelectSingleNode("PronationROMNormal") == null ? txtExtension3.Text.ToString().Trim() : node.SelectSingleNode("PronationROMNormal").InnerText;
