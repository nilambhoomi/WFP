...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   :  inherit;
    ...
    >
        ...
        ve > . a le-bordered {
                b r er:  0;
           .p n l  > .table-bord r d > t o y  r >  td:first-ch     .p n l  > .table-bord r d > t o y  r >  th:first-ch     .p n l  > .table-bord r d > t o t  r >  td:first-ch     .p n l  > .table-bord r d > t o t  r >  th:first-ch     .p n l  > .table-bord r d > t e d  r >  td:first-ch     .p n l  > .table-border d >  thead > tr > h first c il ,
        
            .p respon i e  > .table-border d >  tbody > tr > d first c il ,
        
            .p respon i e  > .table-border d >  tbody > tr > h first c il ,
        
            .p respon i e  > .table-border d >  tfoot > tr > d first c il ,
        
            .p respon i e  > .table-border d >  tfoot > tr > h first c il ,
        
            .p respon i e  > .table-border d >  thead > tr > d first c il ,
        ...
        t-chil          
              borde - ef : 0;        
               . a el > .table-bor e ed > b dy > tr  > td:last-c      . a el > .table-bor e ed > b dy > tr  > th:last-c      . a el > .table-bor e ed > f ot > tr  > td:last-c      . a el > .table-bor e ed > f ot > tr  > th:last-c      . a el > .table-bor e ed > h ad > tr  > td:last-c      . a el > .table-borde e  > thead > tr > t :last c il ,
        
            . -respo s ve > .table-borde e  > tbody > tr > t :last c il ,
        
            . -respo s ve > .table-borde e  > tbody > tr > t :last c il ,
        
            . -respo s ve > .table-borde e  > tfoot > tr > t :last c il ,
        
            . -respo s ve > .table-borde e  > tfoot > tr > t :last c il ,
        
            . -respo s ve > .table-borde e  > thead > tr > t :last c il ,
        ...
        -child {
                       ...
                       order r ght: 0;
             .p n l  > .table-bord r d > t o y >  tr:first-c i d >     .p n l  > .table-bord r d > t o y >  tr:first-c i d >     .p n l  > .table-bord r d > t e d >  tr:first-c i d >     .p n l  > .table-border d >  thead > tr:fi s -chil   th,
          .p respon i e  > .table-border d >  tbody > tr:fi s -chil   td,
          .p respon i e  > .table-border d >  tbody > tr:fi s -chil   th,
          .p respon i e  > .table-border d >  thead > tr:fi s -chil   td,
          . a
            nsive > .table bo
         
         > th                        b rder- o tom: 0;
             . a el > .table-bor e ed > b dy  > tr:last- h ld      . a el > .table-bor e ed > b dy  > tr:last- h ld      . a el > .table-bor e ed > f ot  > tr:last- h ld      . a el > .table-borde e  > tfoot > tr:l s -chil   th,
          . -respo s ve > .table-borde e  > tbody > tr:l s -chil   td,
          . -respo s ve > .table-borde e  > tbody > tr:l s -chil   th,
          . -respo s ve > .table-borde e  > tfoot > tr:l s -chil   td,
          p
            onsive > .tabl -b
        t
