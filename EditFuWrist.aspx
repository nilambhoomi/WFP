                ...
                <div class="row">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                        <div id="WrapLeft" runat="server">
                            ...
                            <asp:CheckBox ID="chkradiusLeft" runat="server" Text="radius  " />
                            <asp:CheckBox ID="chkDorsalLeft" runat="server" Text="dorsum of the wrist  " />
                            <asp:CheckBox ID="chkPalmarLeft" runat="server" Text="palmar side of the wrist.  " />
                        ...
                        <div id="wrpRight" runat="server">
                            ...
                            <asp:CheckBox ID="chkradiusRight" runat="server" Text="radius  " />
                            <asp:CheckBox ID="chkDorsalRight" runat="server" Text="dorsum of the wrist  " />
                            <asp:CheckBox ID="chkPalmarRight" runat="server" Text="palmar side of the wrist.  " />
                            <label class="control-label">The elbow  pain is worsened with &nbsp; </label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                        <div id="wrpPELeft" runat="server">
                            ...
                            <asp:CheckBox ID="chkPalpationUlnarLeft" runat="server" Text="ulna  " />
                            <asp:CheckBox ID="chkPalpationRadialLeft" runat="server" Text="radius " />
                            <asp:CheckBox ID="chkPalpationDorsalLeft" runat="server" Text="dorsum  " />
                        ...
                        <div id="wrpPERight" runat="server">
                            ...
                            <asp:CheckBox ID="chkPalpationUlnarRight" runat="server" Text="ulna  " />
                            <asp:CheckBox ID="chkPalpationRadialRight" runat="server" Text="radius " />
                            <asp:CheckBox ID="chkPalpationDorsalRight" runat="server" Text="dorsum  " />
