<%@ Page Title="" Language="C#" MasterPageFile="~/common.master" AutoEventWireup="true" CodeFile="WFPIEReportsNew.aspx.cs" Inherits="WFPIEReportsNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            $.ajax({
                type: "POST",
                url: "WFPIEReportsNew.aspx/GetIEReport",
