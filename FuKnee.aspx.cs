...
public partial class FuKnee : System.Web.UI.Page
{
    ...
    public void PopulateUI(string fuID)
    {
        ...
        if (sqlTbl.Rows.Count > 0)
        {
            ...
            txtFwdFlexNormal.Text = Convert.ToString(TblRow["FlexNormal"]);
            txtExtensionNormal.Text = Convert.ToString(TblRow["ExtensionNormal"]);
    ...
    public void BindDCDataGrid()
    {
        ...
        try
        {
            if (!IsPostBack)
            {
                ...
                oSQLCmd.Parameters.AddWithValue("@is_previous", false);
