...
public partial class Page1 : System.Web.UI.Page
{
    ...
    private void bindEditData(string PatientIEid)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (!string.IsNullOrEmpty(Convert.ToString(txtMAProviders.Items.FindByText(ds.Tables[0].Rows[0]["MA_Providers"].ToString()))))
            {
                txtMAProviders.Items.FindByText(ds.Tables[0].Rows[0]["MA_Providers"].ToString()).Selected = true;
            }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        param[0] = new SqlParameter("@FirstName", txt_fname.Text);
        param[1] = new SqlParameter("@LastName", txt_lname.Text);
        ...
        param[30] = new SqlParameter("@MA_Providers", txtMAProviders.SelectedItem.Text);
