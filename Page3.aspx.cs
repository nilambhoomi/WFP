...
public partial class Page3 : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (ds.Tables[0].Rows.Count == 0)
        {
            ...
            query = query + "Bowel,RecentWeightloss,Episodic,Rashes,PatientIE_ID,NightSweats,DoubleVision,HearingLoss,Depression,ISFirst,dloodinurine) values (";
            ...
            query = query + "'" + chk_sleep_disturbance.Checked + "','" + chk_blurred.Checked + "','" + chk_hearing_loss.Checked + "','" + chk_depression.Checked + "',1,'" + chk_bloodinurine.Checked + "' )";
        }
        else
        {
            ...
            query = query + "',HearingLoss='" + chk_hearing_loss.Checked + "',Depression = '" + chk_depression.Checked + "',ISFirst=1 , dloodinurine = '" + chk_bloodinurine.Checked + "'";
