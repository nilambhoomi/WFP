                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9" style="margin-top: 5px">
                            ...
                            <div id="wrpLeft2" runat="server">
                                ...
                                <asp:Label Font-Bold="false" runat="server" Text="There is tenderness upon palpation of the Left elbow. Range of motion &nbsp;"></asp:Label>
                                ...
                                <%--<asp:DropDownList ID="cboRangeOfMotionLeft" Width="1500px" DataSourceID="RangeOfMotionLeft" DataTextField="name"   runat="server"></asp:DropDownList>
                                    <asp:XmlDataSource ID="RangeOfMotionLeft" runat="server" DataFile="~/xml/HSMData.xml" XPath="HSM/ROMs/ROM" />
                                    <asp:TextBox Width="100px"  Style="height: 15px;" ID="txtExtraForRangeOfMotionLeft" runat="server"></asp:TextBox>--%>
                                <asp:Label runat="server" Font-Bold="false" Text="&nbsp; "></asp:Label><br />
                                ...
                                <%--<asp:DropDownList ID="cboTinelLeft"  Width="100px"  DataSourceID="TinelLeft" DataTextField="name"   runat="server"></asp:DropDownList>
                                    <asp:XmlDataSource ID="TinelLeft" runat="server" DataFile="~/xml/HSMData.xml" XPath="HSM/Results/Result" />
                                     <asp:TextBox Width="100px"  Style="height: 15px;" ID="txtExtraForTinelLeft" runat="server"></asp:TextBox>--%>
                            </div>
                            <br />
                            <div id="wrpRight2" runat="server">
                                <asp:Label Font-Bold="false" runat="server" Text="There is tenderness upon palpation of the Right elbow. Range of motion &nbsp;"></asp:Label>
                                <editable:EditableDropDownList runat="server" ID="cboRangeOfMotionRight" Width="257px" CssClass="inline">
                                </editable:EditableDropDownList>
                                <%--<asp:DropDownList ID="cboRangeOfMotionRight"  Width="100px" DataSourceID="RangeOfMotionRight" DataTextField="name"  runat="server"></asp:DropDownList>
                                    <asp:XmlDataSource ID="RangeOfMotionRight" runat="server" DataFile="~/xml/HSMData.xml" XPath="HSM/ROMs/ROM" />
                                    <asp:TextBox Width="100px"  Style="height: 15px;" ID="txtExtraForRangeOfMotionRight" runat="server"></asp:TextBox>--%>
                                <asp:Label runat="server" Font-Bold="false" Text="&nbsp; "></asp:Label><br />
                                <asp:Label runat="server" Font-Bold="false" Text="&nbsp;Tinel is &nbsp;"></asp:Label>
                                <editable:EditableDropDownList runat="server" ID="cboTinelRight" Width="257px" CssClass="inline">
                                </editable:EditableDropDownList>
                                <%-- <asp:DropDownList ID="cboTinelRight"  Width="100px" DataSourceID="TinelRight" DataTextField="name"  runat="server"></asp:DropDownList>
                                    <asp:XmlDataSource ID="TinelRight" runat="server" DataFile="~/xml/HSMData.xml" XPath="HSM/Results/Result" />
                                    <asp:TextBox Width="100px"  Style="height: 15px;" ID="txtExtraForTinelRight" runat="server"></asp:TextBox>--%>
                            </div>
                        </div>
                    </div>
                    <div class="row">
