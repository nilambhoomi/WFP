<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="SoapReport1.aspx.cs" Inherits="SoapReport1" %>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="input-group">
                    ...
                    <asp:DropDownList runat="server" ID="ddl_casetype" Width="150px">
                    </asp:DropDownList>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="input-group">
                    <asp:Button ID="btnprintbulk" runat="server" CssClass="btn btn-primary" OnClick="btnprintbulk_Click" Text="print bulk" />
                </div>
            </div>
        </div>
