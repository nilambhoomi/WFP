...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%-- CN Form Start --%>
    <div class="modal fade" id="CNPopUp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                ...
                <div class="modal-body">
                    <div id="source-html">
                        <p>CN Form</p>
                        <p>
                            You have a pain problem that has not been relieved by routine treatments. A procedure, specifically an
                         injection or operation, is now indicated for further evaluation or treatment of your pain. There is <b>no 
                         guarantee</b> that a procedure will cure your pain, and in rare cases, it could become worse, even when the
                         procedure is performed in a technically perfect manner. The degree and duration of pain relief varies from
                         person to person, so after your procedure, we will reevaluate your progress, then determine if further 
                         treatment is necessary. Your physician will explain the details of the procedure listed below.<b> Tell the 
                         physician if you are taking any blood thinners such as Coumadin, Lovenox, Heparin, Plavix, Warfarin, </b>as 
                         these can cause excessive bleeding and a procedure should not be performed.
                        </p>
                        <br />
                        <p>
                            <b>Alternatives</b> to the procedure include medications, physical therapy, acupuncture, surgery, etc.
                        <b>Benefits</b> include increased likelihood of correct diagnosis and /or of decrease or elimination of pain.
                        <b>Risks</b> include infection, bleeding, allergic reaction, increased pain; nerve damage involving temporary or 
                        permanent pain, numbness, weakness, paralysis or death; air in lung requiring chest tube; tissue, bone or 
                        eye damage from steroids. Nerve destruction with phenol, alcohol, or radiofrequency energy has risks of 
                        nerve and tissue damage. <b>Specific risks</b> pertaining to each specific procedure are as follows:
                        </p>
                        <br />
                        <p>
                            <b>Trigger Point Injection, Joint Injection, Occipital Nerve Block, Intercostal Nerve Block/Ablation: Air </b>
                            in lung requiring chest tube in hospital, local pain from tissue and/or nerve irritation, dimpling of/depression in skin.
                        </p>
                        <br />
                        <p>
                            <b>Joint and Bursal Injections:</b>infection and local site reactions.
                        </p><br />
                        <p>
                            I also understand that one of the greatest risks involved with pain management procedures 
                            involves various medications taken, allergies and my general medical condition. I will inform the 
                            doctor of any blood thinning medication taken or any changes in other medications, allergies or 
                            medical condition prior to any procedure.
                        </p><br />
                        <p>
                            I am signing this consent form as the above mentioned patient granting full consent to the provider above 
                            to perform the necessary testing / procedure.
                        </p><br />
                        <p>
                            I further expressly understand that the following procedure which is mentioned above has been 
                            performed on me today.
                        </p>
                        <p>
                            Patient or his/her legal guardian signature.
                        </p>
                    </div>
                </div>
                <div class="modal-footer" style="margin-right: 18px">
                    <%--<button type="button" onclick="CreateProc()" class="btn btn-default" data-dismiss="modal">Create New Procedure</button>--%>
                    <button type="button" onclick="PrintCN()" class="btn btn-primary">Print Form</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function PrintCN() {
            ...
            //var HTML = $('#CNPopUp').html();
            //$.ajax({
            //    type: "POST",
            //    url: "POC.aspx/printcnform",
            //    data: "{'html':'" + HTML + "'}",
            //    contentType: "application/json;charset=utf-8",
            //    dataType: "json",
            //    success: function (data) {
