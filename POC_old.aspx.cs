...
public partial class POC : System.Web.UI.Page
{
   ...
   [WebMethod]
    public static void printcnform(string html)
    {
        //createWordDocument(html);
        //return "true";
        ...
        strHTMLContent.Append("<html><body>" + html + "</body></html>");
    ...
    public static void createWordDocument(string strHTML)
    {
        HttpContext.Current.Response.Clear();
        HttpContext.Current.Response.Charset = "";
        HttpContext.Current.Response.ContentType = "application/msword";
